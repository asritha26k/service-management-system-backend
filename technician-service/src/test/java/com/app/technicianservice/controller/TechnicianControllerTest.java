...
class TechnicianControllerTest {
    ...
    void updateMyAvailability_ShouldReturnNoContent() throws Exception {
        ...
        when(technicianService.updateMyAvailability(any(RequestUser.class), any(AvailabilityUpdateRequest.class)))
                .thenReturn(profileResponse);
    ...
    void updateWorkload_ShouldReturnNoContent() throws Exception {
        ...
        when(technicianService.updateWorkload(eq("profile-1"), eq(3))).thenReturn(workload);
